<template>
    <div>
        ...
        <v-row>
            ...
            <v-col cols="12" md="4">
                <div class="titular text-center">EDITAR CATEGORIA</div>
            </v-col>
            <v-col cols="0" md="4"></v-col>
        </v-row>
...
<script>
    ...
    async created(){
            ...
            let data = {
                ...
                nombreID: this.$route.params.id,
                func: 'consultarCategoria',
            };
                ...
                if (isValid) { //Valido, decodificamos el jwt
                    ...
                    if (decoded.status) { //Datos como los esperabamos
                        ...
                        if (decoded.data){ //Si hay datos
                            let categoria = decoded.data
                            this.$v.nombre.$model = categoria.nombre
                            this.$v.descripcion.$model = categoria.descripcion
                ...
                if (isValid) { //Valido, decodificamos el jwt
                    ...
                    if (decoded.status) { //Datos como los esperabamos
                        ...
                        if (decoded.editada){ //Si esta creado
                            ...
                            this.error=true
                            this.mensaje = 'LA CATEGORIA NO HA PODIDO EDITARSE'
                            this.cargando = false
                            setTimeout(()=> this.control = false, 2000)
                            setTimeout(()=> this.mensaje = '', 2000)
                        }
